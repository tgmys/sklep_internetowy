...
using sklep_internetowy.Migrations;
    ...
    public class KursyInitializer : MigrateDatabaseToLatestVersion<KursyContext, Configuration>
    {
        ...
        public static void SeedKursyData(KursyContext context)
        {
            ...
            var kursy = new List<Kurs>
            {
                ...
                new Kurs() { KursId=4, AutorKursu="Tomasz", TytulKursu="JavaScript", KategoriaID=2, CenaKursu=70, Bestseller=false, NazwaPlikuObrazka="obrazekjavascript.png",
                DataDodania = DateTime.Now, OpisKursu="Kurs JavaScript - skryptowy język programowania"},
                new Kurs() { KursId=5, AutorKursu="Tomasz", TytulKursu="jQuery", KategoriaID=3, CenaKursu=90, Bestseller=true, NazwaPlikuObrazka="obrazekjquery.png",
                DataDodania = DateTime.Now, OpisKursu="Kurs jQuery - lekka biblioteka programistyczna dla języka JavaScript"},
                new Kurs() { KursId=6, AutorKursu="Tomasz", TytulKursu="Html5", KategoriaID=4, CenaKursu=70, Bestseller=false, NazwaPlikuObrazka="obrazekhtml.png",
                DataDodania = DateTime.Now, OpisKursu="Kurs Html5 - język wykorzystywany do tworzenia i prezentowania stron internetowych www"},

                new Kurs() { KursId=7, AutorKursu="Tomasz", TytulKursu="Css3", KategoriaID=5, CenaKursu=70, Bestseller=false, NazwaPlikuObrazka="obrazekcss.png",
                ...
                new Kurs() { KursId=9, AutorKursu="Tomasz", TytulKursu="C#", KategoriaID=7, CenaKursu=90, Bestseller=true, NazwaPlikuObrazka="obrazekcsharp.png",
        ...
        public static void SeedUzytkownicy(KursyContext db)
        {
            ...
            const string name = "admin@eklep.pl";
